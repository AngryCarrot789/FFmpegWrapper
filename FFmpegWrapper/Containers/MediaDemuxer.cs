...
namespace FFmpeg.Wrapper {
    ...
    public unsafe class MediaDemuxer : FFObject {
        ...
        public TimeSpan? Duration => Helpers.GetTimeSpan(_ctx->duration, new AVRational() {num = 1, den = ffmpeg.AV_TIME_BASE});
        ...
        public MediaDecoder CreateStreamDecoder(MediaStream stream, bool open = true) {
            ...
            switch (stream.Type) {
                case MediaTypes.Audio: decoder = new AudioDecoder(codecId) as MediaDecoder; break;
                case MediaTypes.Video: decoder = new VideoDecoder(codecId); break;
